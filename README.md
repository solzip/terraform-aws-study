...
문서 링크는 GitHub Actions가 자동으로 검사합니다 ([link-check.yml](https://github.com/solzip/terraform-aws-study/blob/main/.github/workflows/link-check.yml) — 워크플로우는 `main` 루트에만 있습니다).
